...
class TCS34725:
    ...
    def Disable(self):
        ...
        self.Write_Byte(self.TCS34725_ENABLE, reg & ~(self.TCS34725_ENABLE_PON | self.TCS34725_ENABLE_AEN));
    ...
    def TCS34725_init(self):
        ...
        if(ID != 0x44 and ID != 0x4D):
            return 1
        self.Set_Integration_Time(self.TCS34725_INTEGRATIONTIME_2_4MS)
        self.Set_Gain(self.TCS34725_GAIN_1X)
        self.IntegrationTime_t = self.TCS34725_INTEGRATIONTIME_2_4MS
        self.Gain_t = self.TCS34725_GAIN_1X
        self.Enable()
    ...
    def GetRGB565(self):
        ...
        self.RGB565_R = int(RGB565_R * 255 / 225)
        self.RGB565_G = int(RGB565_G * 255 / 225)
        self.RGB565_B = int(RGB565_B * 255 / 225)  
    ...
    def Get_ColorTemp(self):
        ir=1.0
        ir =  (self.R + self.G + self.B - self.C - 1)/192.1682 
        r_comp = self.R - ir;
        b_comp = self.B - ir;
    ...
    def GetXYZ(self):
        ...
        self.X = -0.14282*r_comp + 1.54924*g_comp - 0.95641*b_comp;
        #self.X = 0.011683*r_comp + 0.004073*g_comp + 0.003374*b_comp;
        self.Y = -0.32466*r_comp + 1.57837*g_comp - 0.73191*b_comp;
        #self.Y = 0.004609*r_comp + 0.016638*g_comp - 0.002545*b_comp;
        self.Z = -0.68202*r_comp + 0.77073*g_comp + 0.56332*b_comp;
        #self.Z = -0.003017*r_comp - 0.005424*g_comp + 0.028669*b_comp;
